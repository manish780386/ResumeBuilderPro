...
export default function TemplateCorporateBlack() {
  ...
  const [data, setData] = useState({
    ...
    about:
      "Detail-oriented developer with strong experience in React, TypeScript, Django APIs, and modern UI design. Passionate about building scalable web applications.",
    phone: "9999999999",
    ...
    experience:
      "2 Years Frontend Developer working on Resume Builder, KisanMitra, Spotify Clone & Person Management System.",
    projects:
  ...
  const downloadPDF = async () => {
    ...
    const fileName = `${data.name}_CorporateBlack_${Date.now()}.pdf`;
  ...
  return (
    <div style={{ background: "#111", minHeight: "100vh", padding: 20 }}>
      ...
      <h1 style={{
        ...
        Resume Builder – Corporate Black
      </h1>
